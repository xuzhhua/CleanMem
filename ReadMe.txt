========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : CleanMem
========================================================================


AppWizard が生成した CleanMem には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには CleanMem を構成している各ファイルの概要説明が含まれています。
...
CleanMem.h
    ...
    みます） をインクルードし、また CCleanMemApp アプリケーションクラスを宣
    言します。

CleanMem.cpp
    このファイルは CCleanMemApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\CleanMem.ico
    ...
    ルです。このアイコンはリソース ファイル CleanMem.rc によってインクルード
    されます。
...
CleanMemDlg.h, CleanMemDlg.cpp - ダイアログ
    これらのファイルは CCleanMemDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な CleanMem.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) CleanMem.pch 
